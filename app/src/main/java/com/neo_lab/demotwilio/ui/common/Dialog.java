package com.neo_lab.demotwilio.ui.common;
...
public class Dialog {
    ...
    private static void setRoomNameFieldInDialog(EditText roomNameEditText, AlertDialog.Builder alertDialogBuilder, Context context) {
        ...
        int horizontalPadding = context.getResources().getDimensionPixelOffset(R.dimen.general_magrin);
        int verticalPadding = context.getResources().getDimensionPixelOffset(R.dimen.general_magrin);
